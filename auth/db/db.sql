...
-- 3. Tabla de Apartamentos (Versión completa y corregida)
CREATE TABLE IF NOT EXISTS apartamentos (
    id INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    titulo VARCHAR(100) NOT NULL,
    slug VARCHAR(255) UNIQUE DEFAULT NULL, -- URL amigable
...
-- Modificando capacidad para aceptar texto (ej: "6 a 8")
ALTER TABLE apartamentos MODIFY COLUMN capacidad VARCHAR(50);

-- Comandos para actualizar la tabla si ya existe (Ejecutar si es necesario)
-- ALTER TABLE apartamentos ADD COLUMN slug VARCHAR(255) UNIQUE AFTER titulo;
-- ALTER TABLE apartamentos ADD COLUMN cama INT(3) DEFAULT 0 AFTER capacidad;
-- ALTER TABLE apartamentos ADD COLUMN pdf VARCHAR(255) DEFAULT NULL AFTER video;
...
-- 9. Ajustes de columnas adicionales (Updates)
-- Agregando columna 'orden' a la galería para ordenamiento personalizado
ALTER TABLE galeria_apartamentos ADD COLUMN orden INT DEFAULT 0;
...
CREATE TABLE IF NOT EXISTS reservas (
    ...
    banco_detalle VARCHAR(100) DEFAULT NULL,
