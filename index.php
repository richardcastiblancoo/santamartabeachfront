...
<head>
    ...
    <meta property="og:image" content="https://santamartabeachfront.com/public/img/logo-definitivo.webp">
    <!-- opengraf X -->
    ...
    <script defer src='https://static.cloudflareinsights.com/beacon.min.js' data-cf-beacon='{"token": "473ac65f42a8432db09ab53c959051d5"}'></script>
...
<body class="bg-background-light dark:bg-background-dark font-display text-[#111618] dark:text-white transition-colors duration-200">
    ...
    <section class="py-20 bg-[#101c22] overflow-hidden" id="apartamentos">
        <div class="px-6 md:px-20 mb-10 text-center">
            <h2 class="text-3xl font-bold text-white mb-2">¡Apartamentos Extraordinarios!</h2>
            ...
            <div class="flex flex-wrap justify-center gap-8 relative z-10">
                ...
                if ($result && $result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        // Consulta de galería optimizada
                            ...
                            <div class="p-6">
                                ...
                                <div class="grid grid-cols-4 gap-2 mb-6">
                                    <div class="flex flex-col items-center gap-1 p-2 bg-white/5 rounded-2xl border border-white/5 hover:bg-white/10 transition-colors">
                                        ...
                                        <span class="text-[10px] text-gray-300"><?php echo $row['habitaciones']; ?> Hab</span>
                                    </div>
                                    <div class="flex flex-col items-center gap-1 p-2 bg-white/5 rounded-2xl border border-white/5 hover:bg-white/10 transition-colors">
                                        <span class="material-symbols-outlined text-blue-400 text-lg">shower</span>
                                        <span class="text-[10px] text-gray-300"><?php echo $row['banos']; ?> Baños</span>
                                    </div>
                                    <div class="flex flex-col items-center gap-1 p-2 bg-white/5 rounded-2xl border border-white/5 hover:bg-white/10 transition-colors">
                                        <span class="material-symbols-outlined text-blue-400 text-lg">groups</span>
                                        <span class="text-[10px] text-gray-300"><?php echo $row['capacidad']; ?> Pers</span>
                                    </div>
                                    <div class="flex flex-col items-center gap-1 p-2 bg-white/5 rounded-2xl border border-white/5 hover:bg-white/10 transition-colors">
                                        <span class="material-symbols-outlined text-blue-400 text-lg">single_bed</span>
                                        <span class="text-[10px] text-gray-300"><?php echo $row['cama']; ?> Camas</span>
                                    </div>
                                </div>
    ...
    <section class="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] min-h-[500px] bg-[#101c22] overflow-hidden" id="ubicacion">
        ...
        <article class="p-10 lg:p-16 flex flex-col justify-center order-2 lg:order-1">
            ...
            <p class="text-gray-400 mb-10 text-lg leading-relaxed max-w-xl">
                Descubre la tranquilidad de <strong>Reserva del Mar 1</strong>, ubicado en la zona más exclusiva y con acceso directo al mar.
            </p>

            <address class="not-italic mb-10 space-y-3 border-l-4 border-blue-600 pl-6 py-2 bg-blue-900/10 rounded-r-xl max-w-md">
                <p class="text-xl font-black text-white">Reserva del Mar 1- Torre 4</p>
