...
<body class="bg-background-light dark:bg-background-dark font-display text-[#111618] dark:text-white transition-colors duration-200">
                        ...
                        <form id="reservaForm" class="space-y-4">
                            ...
                            <div class="space-y-1">
                                ...
                                <select id="accommodation" name="accommodation" class="glass-input w-full rounded-xl px-4 py-3 text-sm bg-slate-800">
                                    <option value="Apartment 1730 - Tower 4 - Reserva del Mar 1">Apartment 1730 - Tower 4 - Reserva del Mar 1</option>
                                </select>
                            </div>
                            <div class="space-y-1">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <article class="bg-[#1e2930]/30 p-6 rounded-2xl border border-white/5 hover:border-blue-500/30 hover:bg-[#1e2930]/50 transition-all duration-300 group">
                    ...
                    <p class="text-gray-400 text-sm leading-relaxed" data-i18n="am_card1_d">Private access to the beach. Step out of your apartment and onto the golden sand instantly.</p>
                </article>
                ...
                <article class="bg-[#1e2930]/30 p-6 rounded-2xl border border-white/5 hover:border-blue-500/30 hover:bg-[#1e2930]/50 transition-all duration-300 group">
                    ...
                    <h3 class="text-lg font-bold mb-2 text-white">Adult & Kids Pools</h3>
                    <p class="text-gray-400 text-sm leading-relaxed">
                        Main pool with panoramic views and a safe children's area designed for family fun.
                    </p>
                </article>
                ...
                <article class="bg-[#1e2930]/30 p-6 rounded-2xl border border-white/5 hover:border-blue-500/30 hover:bg-[#1e2930]/50 transition-all duration-300 group">
                    ...
                    <h3 class="text-lg font-bold mb-2 text-white">Jacuzzi & Wellness</h3>
                    <p class="text-gray-400 text-sm leading-relaxed">
                        Total relaxation with hydro-massage, Finnish sauna, and luxury Turkish bath for your health and well-being.
                    </p>
                </article>
                ...
                <article class="bg-[#1e2930]/30 p-6 rounded-2xl border border-white/5 hover:border-blue-500/30 hover:bg-[#1e2930]/50 transition-all duration-300 group">
                    ...
                    <p class="text-gray-400 text-sm leading-relaxed">Rooftop bar featuring premium cocktails and the best panoramic views of the coast.</p>
                </article>
        ...
        <div class="max-w-7xl mx-auto mb-16 px-6">
            <header class="text-center">
                <div class="flex justify-center mb-6">
                    <a href="https://es-l.airbnb.com/rooms/803464527989675272?guests=1&adults=1&s=67&unique_share_id=81c8d8e4-08b0-4891-a0a3-4926979caf3e" target="_blank">
    ...
    <script>
        const reseñas = [{
            ...
            },
            {
                nombre: "Melissa",
                ubicacion: "New York, USA",
                texto: "Are you ready to be pampered? You can't beat that view and the value this apartment has; it's like a mini resort.",
                inicial: "M"
            },
            {
                nombre: "Jonathan",
                ubicacion: "Manizales, Colombia",
                texto: "Everything as described, the location is very good, the building's common areas are excellent, service is timely and fast.",
                inicial: "J"
            },
            {
                nombre: "Leyder",
                ubicacion: "California, USA",
                texto: "What a gem of a place! The apartment has it all and more. Photos don't do it justice. We had breakfast facing the sea every day.",
                inicial: "L"
            },
            {
                nombre: "Maria",
            ...
            },
            {
                ...
                texto: "The apartment is superior. Perfectly clean, well-equipped, and instant communication. The host fulfilled all requests.",
                inicial: "C"
            },
            {
            ...
            },
            {
                ...
                texto: "A place just like the photos. We forgot a computer and they helped us immensely to recover it. We will keep it in mind for next time.",
                inicial: "L"
            },
            {
                nombre: "Diego",
                ubicacion: "Rionegro, Colombia",
                texto: "Wonderful apartment, much better than in the photos. The complex is spectacular, you don't even need to leave to have the best time.",
                inicial: "D"
            }
        ];
    ...
    <!-- ubicacion -->
    <section class="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] min-h-[500px] bg-[#101c22] overflow-hidden" id="location">
        ...
        <article class="p-10 lg:p-16 flex flex-col justify-center order-2 lg:order-1">
            ...
            <p class="text-gray-400 mb-10 text-lg leading-relaxed max-w-xl">
                Discover the tranquility of <strong>Reserva del Mar 1</strong>, located in the most exclusive area with direct beach access.
            </p>

            <address class="not-italic mb-10 space-y-3 border-l-4 border-blue-600 pl-6 py-2 bg-blue-900/10 rounded-r-xl max-w-md">
                <p class="text-xl font-black text-white">Reserva del Mar 1 - Tower 4</p>
            ...
            <ul class="space-y-4 mb-10" role="list">
                <li class="flex items-center gap-4 group">
                    ...
                    <span class="text-gray-300 font-medium text-base">Just 30 yards from the beach</span>
                </li>
                <li class="flex items-center gap-4 group">
                    ...
                    <span class="text-gray-300 font-medium text-base">15 min from International Airport</span>
                </li>
                <li class="flex items-center gap-4 group">
                    ...
                    <span class="text-gray-300 font-medium text-base">5 min from Dining & Gastronomy Zone</span>
                </li>
            </ul>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            async function iniciarTour() {
                while (true) {
                    // STEP 1: PLANET
                    status.innerText = "1. Planet Earth";
